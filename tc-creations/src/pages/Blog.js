...
class Blog extends Component {
  ...
  exitFullArticle(){
    console.log('exitFullArticle reached');
    this.setState({
      fullArticle: {
        view: false,
        articleId: '',
  ...
  postRender(){
    if(this.state.fullArticle.articleId == ''){
      if(this.state.windowWidth < 800){
        return (
          <div className='blogPosts'>
            {this.state.blogPosts.map(function(post, i){
              return(
                <div key={i} id={i} className='post' onClick={this.articleRender.bind(this, i)}>
        ...
        console.log(this.state.fullArticle, this.state.fullArticle.bkgdImg);
      ...
      if(this.state.windowWidth < 800){
        ...
        return (
          <div className='blogPosts' style={style}>
